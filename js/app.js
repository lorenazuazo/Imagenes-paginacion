...
function validarFormulario(e){
    ...
    if(terminoBusqueda === ''){
        mostrarAlerta('El termino de busqueda es obligatorio');
        return
    }
...
//generador que va a regisstrar la cantidad de elementos de acuerdo a las paginas
